...
import {
  ...
  setSmCatalogCategoryIndividualUnits,
...
router.post(
  "/category-individual-units",
  asyncHandler(async (req, res) => {
    res.json(await setSmCatalogCategoryIndividualUnits(req.body?.category, req.body?.individualUnits));
  })
);
